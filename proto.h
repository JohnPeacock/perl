...
PERL_CALLCONV const char*	Perl_prescan_version(pTHX_ const char *s, bool strict, bool *sqv, int *ssaw_period, int *swidth, bool *salpha)
			__attribute__nonnull__(pTHX_1);
...
STATIC char*	S_force_package_version(pTHX_ char *s, int guessing)
			__attribute__nonnull__(pTHX_1);
